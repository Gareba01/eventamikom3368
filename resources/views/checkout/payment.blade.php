...
<script type="text/javascript">
    document.getElementById('pay-button').onclick = function () {
        // Memicu jendela popup Midtrans menggunakan snap_token yang dikirim dari controller
    ...
    // Otomatis memicu klik tombol saat halaman selesai dimuat agar popup langsung muncul
