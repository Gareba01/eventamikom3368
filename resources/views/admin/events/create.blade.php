...
<div class="bg-white rounded-[2.5rem] border border-slate-100 p-10 shadow-sm max-w-4x1">
    <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="col-span-2">
                <label class="block text-sm font-bold text-slate-700 mb-2 uppercase">Upload Poster</label>
        ...
        <div class="flex justify-end gap-4 mt-8">
            ...
            <button type="submit" class="px-8 py-3 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg hover:bg-indigo-700 transition">Simpan Event</button>
        </div>
    </form>
</div>
@endsection